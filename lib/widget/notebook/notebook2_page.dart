...
class Notebook2Page extends StatefulWidget {
  const Notebook2Page({super.key});

  @override
  State<Notebook2Page> createState() => _Notebook2PageState();
}

class _Notebook2PageState extends State<Notebook2Page> {
  ...
  Future<void> _loadContent() async {
    ...
    _entries = await CacheUtils.readEntries();
    setState(() {
      _isLoading = false;
    });
  }
  ...
  Future<void> _saveEntry(DiaryEntry entry) async {
    ...
    await CacheUtils.writeEntries(_entries);
    setState(() {});
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('记事本2 (CacheUtils)'),
